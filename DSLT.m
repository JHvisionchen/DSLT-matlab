...
net_weights =fullfile('/media/cjh/cvpaper/git/models/dslt_models/new_vgg_net.caffemodel');  % revised VGG model
prototxt = 'prototxt/';
...
%% ================================================================
adjust_solver.net.save('/media/cjh/cvpaper/git/models/dslt_models/finetune_net.caffemodel');
adjust_solver.net.set_net_phase('test');
adjust_solver1.net.copy_from('/media/cjh/cvpaper/git/models/dslt_models/finetune_net.caffemodel');
positions = [];
tic;
